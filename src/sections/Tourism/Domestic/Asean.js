        ...
        <ul className="grid-servive">
          ...
          <li className="grid-service--list">
            <div className="card-wrapper">
              ...
              <a href="https://drive.google.com/file/d/1qksXSbH2trSQr3eGCYlRRaVacQpzzxdb/view?usp=sharing" className="title-wrapper" target="_blank" rel="noopener noreferrer">
                <p>Bali</p>
                <i className="fas fa-chevron-right"></i>
              </a>
            </div>
          ...
          <li className="grid-service--list">
            <div className="card-wrapper">
              ...
              <a href="https://drive.google.com/file/d/19mLJZ_qOZbwAKs4lZyujXjzhN54X05eM/view?usp=sharing" className="title-wrapper" target="_blank" rel="noopener noreferrer">
                <p>Belitung</p>
                <i className="fas fa-chevron-right"></i>
              </a>
            </div>
          ...
          <li className="grid-service--list">
            <div className="card-wrapper">
              ...
              <a href="https://drive.google.com/file/d/1J0wN18-2K3Oqo1Y9Keun-w46C9hFt0Lu/view?usp=sharing" className="title-wrapper" target="_blank" rel="noopener noreferrer">
                <p>Palembang</p>
                <i className="fas fa-chevron-right"></i>
              </a>
            </div>
